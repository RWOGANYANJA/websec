...
<form action="login.php" method="POST" class="form">
	<h2>Sign up</h2>
	<input type="text" name="uname" placeholder="username" value="<?php if(isset($_COOKIE["uname"])) { echo $_COOKIE["uname"]; } ?>"><br><br>
	<input type="password" name="pwd" placeholder="password"  value="<?php if(isset($_COOKIE["pwd"])) { echo $_COOKIE["pwd"]; } ?>"><br><br>
